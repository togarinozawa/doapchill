...
enum class PointReason(val label: String) {
     ...
     * 集中モードを時間より前に切り上げた。
     *
     * [isViolation] に**入れない**。自分で始めて自分でやめただけで、
     * 決めたルールを破ったわけではない。連続記録まで切ると、
     * 集中を始めること自体が損になる。
     */
    FOCUS_ABORTED("集中を切り上げた"),
...
data class PointPolicy(
     ...
     * 集中モードを完走したときの加点。
     *
     * 長さに比例させない。5分を12回に割って稼げてしまうと、
     * 集中そのものではなく数を稼ぐ遊びになる。
     */
    val focusDonePoints: Int = 5,

    /** 集中モードを時間より前に切り上げるときに払うぶん。 */
    val focusAbortCost: Int = 10,
